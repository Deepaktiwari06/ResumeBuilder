...
export const authStyles = {
  container: "w-[92vw] md:w-[520px] p-10 bg-gradient-to-br from-white to-violet-50 rounded-3xl border border-violet-100 shadow-2xl",
  headerWrapper: "text-center mb-8",
  title: "text-3xl sm:text-3xl font-extrabold text-slate-900 mb-2",
  subtitle: "text-slate-600 font-medium text-lg",
  form: "space-y-6",
  /* inputs used by Input.jsx */
  inputGroup: "mb-4 w-full",
  label: "block text-sm font-semibold text-gray-700 mb-2",
  input: "w-full bg-white border border-gray-200 px-4 py-3 rounded-xl placeholder-gray-400 text-gray-800 focus:border-violet-500 focus:ring-4 focus:ring-violet-50 transition-all outline-none text-base",
  errorMessage: "text-red-600 text-sm font-medium bg-red-50 border border-red-200 px-4 py-3 rounded-xl",
  submitButton: "w-full py-5 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-extrabold rounded-2xl hover:scale-105 hover:shadow-2xl hover:shadow-violet-300 transition-all text-xl",
  ...
  signupContainer: "w-[92vw] md:w-[520px] p-10 bg-gradient-to-br from-white to-rose-50 rounded-3xl border border-rose-100 shadow-2xl overflow-hidden",
  signupTitle: "text-3xl font-extrabold text-slate-900 mb-2",
  signupSubtitle: "text-slate-600 font-medium text-lg",
  signupForm: "space-y-4",
  signupSubmit: "w-full py-5 bg-gradient-to-r from-rose-500 to-pink-600 text-white font-extrabold rounded-2xl hover:scale-105 hover:shadow-2xl hover:shadow-rose-200 transition-all text-xl",
...
export const inputStyles = {
  wrapper: "mb-5 w-full block group",
  label: "block text-sm font-bold text-gray-800 mb-3 group-focus-within:text-violet-600 transition-colors",
  inputContainer: focused => `relative flex items-center w-full bg-gray-50 border-2 px-4 py-3 rounded-xl transition-all duration-300 ${focused
