...
const StepProgress = ({ progress }) => {
  return (
    <>
      ...
      <div
        className="ralative w-full h-4 bg-white/5 backdrop-blur-2xl overflolow-hidden rounded-full 
    border border-white/10"
      >
        <div className="absolute inset-0 bg-gradient-to-r from-violet-500/20 to-fuchsia-500/20 animate-pulse" />
        {/* main progress bar */}
        <div
          className="relative h-full bg-gradient-to-r from-violet-500 via-funchsia-500 to-violet-600 
          animate-flow bg-[length:200%] transition-all duratrion-700 ease-out rounded-full overflow-hidden 
         animate-pulse-glow"
        ...
        {progress > 0 && (
            <div className="absolute top-0 h-full w-8 bg-gradient-to-r grom-transparent 
